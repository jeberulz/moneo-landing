                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {member.status === "pending" && (
                        <span className="text-xs font-geist px-2 py-0.5 rounded-full bg-amber-500/15 text-amber-300">
                          Pending
                        </span>
                      )}
                    </div>
                    <p className="text-xs font-geist text-neutral-400 mt-1 flex items-center gap-1">
                      <Mail className="w-3 h-3" />
                      {member.email}
                    </p>
                    <div className="mt-2 flex items-center gap-2">
                      <span
                        className={`text-xs font-geist px-2 py-0.5 rounded-full ring-1 ${getRoleColor(member.role)}`}
                      >
                        {member.role}
                      </span>
